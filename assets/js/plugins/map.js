document.addEventListener('DOMContentLoaded', function() {
    // Проверка наличия элемента карты на странице
    if (document.getElementById('map') && typeof mapData !== 'undefined') {
        // Проверка, содержит ли объект mapData все необходимые данные
        if (mapData && mapData.api_key && mapData.address && mapData.title) {
            ...
            console.error('mapData is not properly defined or missing required fields.');
        }
    }
});
